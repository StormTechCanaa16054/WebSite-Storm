...
export default function App() {
  return (
    <div className="relative h-screen bg-cover bg-center" style={{ backgroundImage: `url(${fotofgc})` }}>
      ...
      <div className="ml-10 relative z-10 h-full p-6 flex flex-col py-40">
        <div className="flex items-center gap-10">
          <h1 className='md:text-8xl text-roxo font-black'>FIRST Global Challenge</h1>
