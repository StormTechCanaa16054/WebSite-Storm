...
export default function App() {
  return (
    <div className="relative h-screen bg-cover bg-center" style={{ backgroundImage: `url(${fotoinfinity})` }}>
      ...
      <div className="relative z-10 h-full p-6 flex flex-col py-40">
        <div className="flex items-center gap-3">
          <h1 className='md:text-7xl text-roxo font-black'>FIRST Robotics Competition</h1>
